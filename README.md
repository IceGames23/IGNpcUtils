...
O plugin fornece utilitários para gerenciar NPCs (um addon) utilizando APIs do plugin [**Citizens2**](https://www.spigotmc.org/resources/citizens.13811/). Ele permite ocultar, exibir, gerenciar NPCs (por jogador ou globalmente) e movê-los de forma eficiente, muito útil para sevidores de Survival, Skyblock, RPG e entre outros.
